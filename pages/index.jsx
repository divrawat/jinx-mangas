...
export default function Home() {
  ...
  const head = () => (
    <Head>
      ...
      <meta name="keywords" content="jinx, jinx manga, jinx manhwa, read jinx, jinx anime, jinx read, baca komik jinx, baca jinx, jinx online, jinx 1, jinx chapter 1, jinx webtoon, manga like jinx, jinx comic, jinx1, jinx 147, jinx 169, jinx light novel, jinx manga online, jinx read online, jinx 149, manga jinx, jinx 165, jinx reddit, only i level up, read jinx, jinx 54, jinx 17, read jinx online, jinx eng, jinx chapter, level up alone, baca manga jinx, manhwa like jinx, manhwa jinx, jinx manga read, jinx komiku, baca manhwa jinx, jinx animation, beru jinx, anime jinx, jinx fandom, manhwa similar to jinx, manga similar to jinx, manga like jinx with op mc, jinx manga free, jinx anime netflix, thomas andre jinx, webtoon jinx, manhwa like jinx with op mc, jinx netflix, anime like jinx, jinx mangago, jinx beru, jinx manhwa, jinx manhwa online, jinx 3, jinx thomas andre, level up alone manga, manga like jinx reddit, manhwa like jinx art, jinx ao3, level up manga, jinx 4, jinx ending, jinx 5, jinx last chapter, jinx anime mappa, leveling manhwa, jinx anime studio,   jinx 18, manhwa with leveling system, jinx 17, jinx 20, jinx 54, jinx volume 5"></meta>
    </Head >
  );
      ...
      <article>
        ...
        <div className='max-w-[1200px] mx-auto md:flex rounded-md md:gap-[80px] bg-[black] mt-8 border border-[#373737] text-[white]'>
          ...
          <div className='md:w-[400px] md:pt-0 pt-6'>
            <img className='   md:mx-0 mx-auto' src={`${COVER_IMG}`} alt="jinx Cover" />
          </div>
        ...
        <h2 id="readmanga" className="font-extrabold text-3xl my-10 px-4 text-center">
          <Link href={DOMAIN} className="hover:underline text-[white]">{`${MANGA_NAME} ${MANGA_TYPE} Chapters`}</Link>
        </h2>
        ...
        <div className="bg-[black] relative">
          ...
          <div className="pt-10 pb-10 max-w-[1100px] mx-auto px-5 text-[white] relative z-10">
            <h2 className="text-center font-extrabold text-3xl">{`More About ${MANGA_NAME} ${MANGA_TYPE}`}</h2>
        ...
        <div className="text-white my-5">
          ...
          {last5chapters?.map((chapter, index) => (
            <div key={index} className="text-center p-1.5 hover:underline"><a href={`${DOMAIN}/chapter-${chapter.chapterNumber}`}>{`${MANGA_NAME} ${MANGA_TYPE} chapter ${chapter.chapterNumber}`}</a></div>
          ))}
        </div>
        ...
        <div className="flex justify-center">
          <iframe width="300" height="350" src="https://www.youtube.com/embed/VUj7l68y7eM?si=5uYUmDhhAt9lx_e_" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
        </div>
